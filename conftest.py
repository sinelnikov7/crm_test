...
def fox_driver_wont_close():
    fox_driver_wont_close = FoxDriver()
    fox_driver_wont_close.set_window_size(1920, 1080)
    return fox_driver_wont_close.get('https://strojregionfilomena.workhere.ru/')

@pytest.fixture
def fox_driver_will_close():
    fox_driver_will_close = FoxDriver()
    fox_driver_will_close.get('https://strojregionfilomena.workhere.ru/')
    fox_driver_will_close.set_window_size(1920, 1080)
...
def browser_autorized_mozila():
    ...
    browser_autorized_mozila.set_window_size(1920, 1080)
